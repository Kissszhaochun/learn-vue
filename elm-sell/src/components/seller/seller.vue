     ...
     <div class="seller-content">
       <div class="overview">
         ...
         <div class="favorite" @click="toggleFavorite">
           ...
           <span class="text-favorite">{{favoriteText}}</span>
         </div>
       </div>
       <split></split>
       <div class="bulletin">
       ...
       <div class="pics">
         ...
         <div class="pic-wrapper" ref="picContent">
    ...
    methods:{
      ...
      initPics (){
        if(this.seller.pics){
          let margin = 6;
          let picWidth = 120;
          let width = (margin+picWidth)*this.seller.pics.length-margin;
          this.$refs.picList.style.width=width+'px';
          if(!this.picScroll){
            this.$nextTick(() =>{
              this.picScroll= new BScroll(this.$refs.picContent,{scrollX:true,eventPassthrough:'vertical'});
            })
          }else{
            this.$nextTick(() =>{
